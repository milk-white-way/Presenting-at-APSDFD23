...
{}\markdownRendererLink{<kbd> <br> Top <br> </kbd>}{#-design-by-t2}{#-design-by-t2}{} </div>\markdownRendererInterblockSeparator
{}\markdownRendererHeadingTwo{Known Issues}\markdownRendererInterblockSeparator
...
\markdownRendererUlItem [] Waybar launching rofi breaks mouse input (added \markdownRendererCodeSpan{sleep 0.1} as workaround), refer https://github.com/Alexays/Waybar/issues/1850\markdownRendererUlItemEnd 
