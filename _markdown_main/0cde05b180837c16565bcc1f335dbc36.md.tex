...
\markdownRendererUlItem Redefine \markdownRendererStrongEmphasis{$\hash\hash\hash\hash$} to start a block with title \linebreakand \markdownRendererStrongEmphasis{\texttt{-{}-{}-{}-}} to end the block\markdownRendererUlItemEnd 
